...
//}
?>
<?php $fetch_data= $res->fetch_assoc(); ?>
<header id="memberlogin1" onclick="enLarge()">
 ...
 timer2 = setInterval(blank, 60);
	...
	<canvas id="abtCanvas" style="width:30em; height:14em; top:7em; left:23em; position:fixed; border:0px solid #d3d3d3; display:block;"></canvas>
