...
{
	header("Location: add_event_p.php");
	exit();
}
...
include("../lib/connection.php");  
	...
	$uploadlocation="../uploaded/";
			...
			$sql_con="INSERT INTO `events_past` SET 
							`name`='$fetchname',
							`link`='$fetchlink',
							`added_on`='$created_on',
							`added_by`='admin'";
			...
			$res2=$mysqli->query($sql_file);
			if($res1 && $res2)	
			{
				@header("Location: p_event_mgt.php?msg=Successful Insert");
				exit();
			}			
	}
...
<input type="hidden"  name="mode" id="mode" value="1" >					
		 ...
		 <tr class="mysty2" bgcolor="#A9B63D" height="18">
    				<td colspan="2" class="mysty2" align="center" bgcolor="#000000"><span class="style2"><strong><font color="#ffffff">Add Past Event</font></strong></span></td>
		  </tr>
