...
{
	header("Location: u_event_edit.php");
	exit();
}
$msgdisplay="";
include("../lib/connection.php");
	...
	$uploadlocation="../uploaded/";
			...
			$sql_con="UPDATE `events_upcoming` SET 
							`name`='$fetchname',
							`date`= '$fetchdate',
							`added_by`='admin',
							`added_on`='$created_on',
...
$sql_event="SELECT * FROM `events_upcoming` WHERE `id`='$id'";
...
<input type="hidden"  name="mode" id="mode" value="<?php echo $id; ?>" >					
		 ...
		 <tr class="mysty2" bgcolor="#A9B63D" height="18">
    				<td colspan="2" class="mysty2" align="center" bgcolor="#000000"><span class="style2"><strong><font color="#ffffff">Edit Upcoming Event</font></strong></span></td>
		  </tr>
...
<td width="332">
<textarea name="link" id="link" cols="30" rows="10"><?php echo $row_event['link']; ?></textarea>
...
<td width="332">
<textarea name="desc" id="desc" cols="40" rows="10"><?php echo $row_event['desc']; ?></textarea>
...
<td width="332">
<textarea name="title" id="title" cols="20" rows="5"><?php echo $row_event['title']; ?></textarea>
...
<td width="332"><input name="venue" value="<?php echo $row_event['venue']; ?>" size="48" id="venue" type="text"></td>
</tr>
...
<td width="332"><input name="date" size="48" id="date" type="date" value="<?php echo $row_event['date']; ?>"></td>
</tr>
