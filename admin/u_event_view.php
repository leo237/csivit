...
{
	header("Location: u_event_view.php");
	exit();
}
$msgdisplay="";
...
$fetchid=$_REQUEST['id'];
$result = $mysqli->query("SELECT * FROM `events_upcoming` WHERE `id`='$fetchid' ");
...
<td width="332">
<img src="../uploaded/<?php echo $fetch_data['image']; ?>" height="400" width="450" border="0" > 
</td>
</tr>
<tr>
<td height="5">&nbsp;</td>
...
<td height="5">&nbsp;</td>
    ...
    <tr>
      <td colspan="2" style="padding-left: 50px;" align="center">
	   <input type="button" value="BACK" name='submit' onClick="window.location.href='u_event_mgt.php'"></td>
    </tr>
