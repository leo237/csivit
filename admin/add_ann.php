...
include("../lib/connection.php");  
	...
	$fetchvisible=$_REQUEST['visible'];
			...
			$sql_con="INSERT INTO `announcement` SET 
							`text`='$fetchtext',
							`link`='$fetchlink',
...
<input type="hidden"  name="mode" id="mode" value="1" >					
		 ...
		 <tr class="mysty2" bgcolor="#A9B63D" height="18">
    				<td colspan="2" class="mysty2" align="center" bgcolor="#000000"><span class="style2"><strong><font color="#ffffff">Add Announcement</font></strong></span></td>
		  </tr>
