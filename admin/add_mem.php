...
include("../lib/connection.php");  
	...
	if($fetchposition!='board')
	{
			$sql_con="INSERT INTO `committee` SET 
							`name`='$fetchname',
							`position`='$fetchposition'";
	}
	else
	{
			$fetchpost=$_REQUEST['post'];
		$uploadlocation="../uploaded/";
			...
			if($res)	
			{
				@header("Location: comm_mgt.php?msg=Successful Insert");
				exit();
			}			
	}
...
<input type="hidden"  name="mode" id="mode" value="1" >					
		 ...
		 <tr class="mysty2" bgcolor="#A9B63D" height="18">
    				<td colspan="2" class="mysty2" align="center" bgcolor="#000000"><span class="style2"><strong><font color="#ffffff">Add Member</font></strong></span></td>
		  </tr>
...
<td width="332"><input name="post" size="48" id="post" type="text"></td>
</tr>
