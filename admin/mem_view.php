...
$fetchid=$_REQUEST['id'];
$result = $mysqli->query("SELECT * FROM `committee` WHERE `id`='$fetchid' ");
...
<table align="left" border="0" cellpadding="0" cellspacing="0" width="90%"  >
		...
		<td align="center" valign="top" width="68%">
		 ...
		 <tr class="mysty2" bgcolor="#A9B63D" height="18">
    				<td colspan="2" class="mysty2" align="center" bgcolor="#000000"><span class="style2"><strong><font color="#ffffff">View Member</font></strong></span></td>
		  </tr>
...
<td width="332">
<img src="../uploaded/<?php echo $fetch_data['image']; ?>" height="200" width="250" border="0" > 
</td>
</tr>
<tr>
<td height="5">&nbsp;</td>
<td height="5">&nbsp;</td>
    ...
    <tr>
      <td colspan="2" style="padding-left: 50px;" align="center">
	   <input type="button" value="BACK" name='submit' onClick="window.location.href='comm_mgt.php'"></td>
    </tr>
